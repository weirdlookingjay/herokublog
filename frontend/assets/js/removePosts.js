...
deleteBtn.addEventListener("click", function(e) {
    ...
    if(postIDs.length > 0) {
        if(confirm("Are you sure you want to delete this?")) {
            ...
            if (httpRequest) {
                httpRequest.open('POST', 'https://blog-coder.herokuapp.com/backend/ajax/removePosts.php', true);
                //httpRequest.open('POST', 'http://herokublog.local/backend/ajax/removePosts.php', true);
